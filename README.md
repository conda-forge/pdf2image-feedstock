...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pdf2image-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8095&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pdf2image-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pdf2image` can be installed with:

```
conda install pdf2image
```

It is possible to list all of the versions of `pdf2image` available on your platform with:
